...
class Solution {
    public int[] countSubTrees(int n, int[][] edges, String labels) {
        ...
        dfs(0, ans, freq, visited, labels, adj);
        return ans;
    }

    public void dfs(int curr, int ans[], int freq[], boolean visited[], String s, ArrayList<Integer> adj[]) {
        if(visited[curr]) {
            return;
        }
        ...
        for(int child: adj[curr]) {
            dfs(child,ans,freq,visited,s,adj);
        }
