...
class Solution {
    public String predictPartyVictory(String senate) {
        ...
        // to keep track how many votes are being cancelled by senator of other party. And don't consider the senate if cancelled vote > 0 its because that senate is being cancelled.
        int pr = 0;
        int pd = 0; 
